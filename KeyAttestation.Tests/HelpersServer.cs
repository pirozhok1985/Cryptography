...
public class HelpersServer : IClassFixture<HelperServerFixture>
{
    private readonly HelperServerFixture _helperServerFixture;

    public HelpersServer(HelperServerFixture helperServerFixture)
    {
        _helperServerFixture = helperServerFixture;
    }

    private const string InvalidCsr =
    ...
    [Fact]
    public void ShouldGenerateValidAttestationData_IfCsrIsValid()
    {
        // Arrange
        var keyAttestationService = _helperServerFixture.KeyAttestationService;
    ...
    [Fact]
    public void ShouldGenerateValidCredential_IfAttestationDataIsValid()
    {
        // Arrange
        var keyAttestationService = _helperServerFixture.KeyAttestationService;
        ...
        // Act
        var attestationData = keyAttestationService.GetAttestationData(ValidCsr);
        var credential = keyAttestationService.MakeCredential(attestationData!, ekPub);
    ...
    [Fact]
    public void ShouldVerifyAttest_IfAttestationDataIsValid()
    {
        // Arrange
        var keyAttestationService = _helperServerFixture.KeyAttestationService;
        
        // Act
        var attestationDataWithInValidCsr = keyAttestationService.GetAttestationData(InvalidCsr);
